...
with open('xgb_plan2.dat', 'rb') as f:
    model = pickle.load(f)
...
features = np.array([SEX,MHDM,zuzhong,MHKF,MAHF,stc,ele_ckmb,age_1,age_2,age_3,age_4,bmp_1,bmp_2,bmp_3,si_1,si_2,si_3]).reshape(1,-1)
